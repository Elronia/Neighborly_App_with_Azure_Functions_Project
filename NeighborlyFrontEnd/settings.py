#--------- Flask settings
SERVER_HOST = 'https://neighborly-front-end.azurewebsites.net' # Update this for the appropriate front-end website when up
SERVER_PORT = 5000
...
API_URL = "https://function-app-neighborly.azurewebsites.net/api/"
